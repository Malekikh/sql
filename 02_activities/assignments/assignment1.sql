...
SELECT sum(count_booth), vendor_id
FROM (
SELECT vendor_id, market_date, count(vendor_id) as count_booth
...
SELECT customer_last_name,customer_first_name, cp.customer_id, sum(quantity * cost_to_customer_per_qty) AS spent_cost
